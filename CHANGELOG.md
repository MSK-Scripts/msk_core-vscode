...
- GitHub Actions: package check on every push. Pushing a `v*` tag publishes
  to Open VSX and creates a GitHub release with the `.vsix` attached. Uses the
  v7 actions on Node.js 24.
